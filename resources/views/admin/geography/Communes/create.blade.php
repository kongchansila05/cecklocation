...
<div class="card shadow mb-4">
    ...
    <form action="/communes/store" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="card-body">
            <div class="row col-md-12">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        <input type="text" class="form-control" id="district_code" name="district_code" value="{{old('district_code')}}">
                        @error('district_code')
